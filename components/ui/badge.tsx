  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-green-600 text-white hover:bg-green-700 hover:scale-105",
        warning:
          "border-transparent bg-yellow-600 text-white hover:bg-yellow-700 hover:scale-105",
        info: "border-transparent bg-blue-600 text-white hover:bg-blue-700 hover:scale-105",
      },
    },
    defaultVariants: {
      variant: "default",
